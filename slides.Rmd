...
+ Paged.js "translate" CSS styles into a page format in an HTML file
...
+ you can (and must) set itss size at the beginning 
...
+ To have a deeper knowledge on the foundations, look at the Paged.js [documentation](https://Paged.js.org/documentation/) or their [Gitlab](https://gitlab.coko.foundation/Paged.js/Paged.js)
